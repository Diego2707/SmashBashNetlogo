...
to setup-player ;sets up the player
  create-players 1 [set ycor min-pycor + 2.2 set xcor -15 set heading 90 set shape "supermario" set color 28 set player-number who set size 1.75]
end

to setup-goomba
  create-goombas 3 [set ycor min-pycor + 1.8 set xcor who set shape "goomba" set color 48]
end

;individual
to setup-ground-blocks [how-many height x-coordinate block-color]
  repeat how-many [ 
    create-ground-blocks 1 [set ycor min-pycor + height set xcor x-coordinate set shape "square" set color 24]
...
to setup-question-blocks [how-many height x-coordinate]
  repeat how-many [
  create-question-blocks 1 [set ycor min-pycor + height  set shape "question" set color 26 set xcor x-coordinate]
  create-mushrooms 1 [set ycor min-pycor + height set shape "mushroom2" set color orange set xcor x-coordinate]
  set x-coordinate x-coordinate + 1
  ]
end  
...
to setup-empty-blocks [how-many height x-coordinate]
  repeat how-many [
  create-empty-blocks 1 [set ycor height set shape "empty" set color 23 set xcor x-coordinate]
  set x-coordinate (x-coordinate + 1)
  ]
end
...
to flash [time];flashes turtle before death 
  set color blue wait time set color yellow wait time set color red wait time set color green wait time set color 28 wait time
end
...
to pace
  set heading 90
  repeat 5 [fd 0.7 wait 0.05]
  wait 0.1
  set heading 270
  repeat 9 [fd 0.7 wait 0.05]
end
@#$#@#$#@
GRAPHICS-WINDOW
210
...
Rectangle -2674135 true false 75 60 105 90
Rectangle -2674135 true false 45 90 60 165
Rectangle -2674135 true false 30 120 45 165
Rectangle -2674135 true false 60 105 75 150
Rectangle -2674135 true false 120 105 180 180
Rectangle -2674135 true false 105 120 120 165
Rectangle -2674135 true false 180 120 195 165
Rectangle -2674135 true false 180 45 195 75
Rectangle -2674135 true false 195 60 225 90
Rectangle -2674135 true false 240 90 255 165
Rectangle -2674135 true false 255 120 270 165
Rectangle -2674135 true false 225 105 240 150
Rectangle -1184463 true true 120 45 180 105
Rectangle -1184463 true true 105 75 120 120
Rectangle -1184463 true true 60 75 75 105
Rectangle -1184463 true true 75 90 105 150
Rectangle -1184463 true true 60 150 105 180
Rectangle -1184463 true true 30 165 120 180
Rectangle -1184463 true true 45 195 60 195
Rectangle -1184463 true true 30 165 60 210
Rectangle -1184463 true true 240 165 270 210
Rectangle -1184463 true true 180 165 270 180
Rectangle -1184463 true true 195 150 240 180
Rectangle -1184463 true true 195 120 225 165
Rectangle -1184463 true true 225 75 240 105
Rectangle -1184463 true true 180 90 225 120
Rectangle -1184463 true true 180 75 195 120
